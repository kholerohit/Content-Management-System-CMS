			...
			if(in_array($ImageActualExt, $allowed))
			{
				if ($ImageError === 0) 
				{
					if ($ImageSize < 10000000) 
					{
						...
						$editid = $_GET['edit'];
						$query = "UPDATE admin_panel SET dateTime='$dateTime', title='$Title',category='$Category',auther='$admin',image='$ImageNameNew',post='$Post'  WHERE id='$editid'";
		...
		<div class="col-sm-10">
			...
			<div>
				...
				<form action="editpost.php?edit=<?php echo $search;?>" method="POST"  enctype="multipart/form-data">
					...
					<input class="btn btn-warning" type="submit" name="submit" value="Update Post">
					</fieldset>	
				</form>
			</div>
			<br>
